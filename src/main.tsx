...
const TiersPage = lazy(() => import('@/pages/members/TiersPage'));
const LeaderboardsPage = lazy(() => import('@/pages/members/LeaderboardsPage'));
const InterestsPage = lazy(() => import('@/pages/members/InterestsPage'));
const ManualApprovalPage = lazy(() => import('@/pages/members/ManualApprovalPage'));
const EarnPointsPage = lazy(() => import('@/pages/loyalty/EarnPointsPage'));
const BurnRulesPage = lazy(() => import('@/pages/loyalty/BurnRulesPage'));
const VouchersPage = lazy(() => import('@/pages/loyalty/VouchersPage'));
const ExternalVouchersPage = lazy(() => import('@/pages/loyalty/ExternalVouchersPage'));
const PushNotificationsPage = lazy(() => import('@/pages/marketing/PushNotificationsPage'));
const VoucherDetailPage = lazy(() => import('@/pages/loyalty/VoucherDetailPage'));
const BadgesPage = lazy(() => import('@/pages/loyalty/BadgesPage'));
const VenuesPage = lazy(() => import('@/pages/ops/VenuesPage'));
const OutletsPage = lazy(() => import('@/pages/ops/OutletsPage'));
const MapsPage = lazy(() => import('@/pages/ops/MapsPage'));
...
const MemberInsightsPage = lazy(() => import('@/pages/insights/MemberInsightsPage'));
...
const GiftCardsPage = lazy(() => import('@/pages/loyalty/GiftCardsPage'));
const HelpFAQPage = lazy(() => import('@/pages/system/HelpFAQPage'));
