      ...
      <div className="max-w-7xl mx-auto space-y-8 animate-fade-in">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          ...
          <div className="flex gap-3">
            ...
            <Button className="bg-indigo-600 h-11 px-6 shadow-indigo-100">Generate Insights</Button>
          </div>
        </div>
              ...
              <Card className={cn(
                ...
                <CardContent>
                  ...
                  <p className="text-[10px] mt-1 flex items-center gap-1 font-bold">
                    ...
                    <span className="text-muted-foreground uppercase">vs prev month</span>
                  </p>
                </CardContent>
                <AnimatePresence>
                  {pulse && (
        ...
        <div className="grid gap-6 lg:grid-cols-12">
          <Card className="lg:col-span-8 shadow-soft border-none overflow-hidden">
            <CardHeader className="flex flex-row items-center justify-between bg-slate-50/50 border-b">
              <div>
                ...
                <CardDescription>Monthly transaction contrasting gross revenue performance</CardDescription>
              </div>
            ...
            <CardContent className="pt-6 h-[400px]">
              <ResponsiveContainer width="100%" height="100%">
                <ComposedChart data={MOCK_DASHBOARD_STATS.insights}>
                  ...
                  <YAxis yAxisId="right" orientation="right" axisLine={false} tickLine={false} tickFormatter={(val) => `${(val / 1000000).toFixed(0)}M`} />
                  <Tooltip contentStyle={{ borderRadius: '12px', border: 'none', boxShadow: '0 20px 25px -5px rgb(0 0 0 / 0.1)' }} />
                  <Bar yAxisId="left" dataKey="transactions" fill="#4F46E5" radius={[6, 6, 0, 0]} barSize={40} name="Count" />
          ...
          <Card className="lg:col-span-12 shadow-soft border-none">
            <CardHeader className="border-b bg-slate-50/30">
              ...
              <CardDescription>Visualizing earning and burning trends over the last cycle</CardDescription>
            </CardHeader>
